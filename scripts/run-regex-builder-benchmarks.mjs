import { benchmarkRegexBuilder } from "../src/intelligence/regex-builder/index.js";

const report = benchmarkRegexBuilder({ seed: "golden-regex-builder" });
const failed = [];

if (report.passed !== report.total) {
  failed.push(`Passed ${report.passed}/${report.total}; expected all Regex Builder benchmarks to pass.`);
}
