import { benchmarkPatternLab } from "../src/intelligence/pattern-lab/index.js";

const report = benchmarkPatternLab({ seed: "golden-pattern-lab" });
const failed = [];

if (report.passed !== report.total) {
  failed.push(`Passed ${report.passed}/${report.total}; expected all Teach It Once benchmarks to pass.`);
}
