import { benchmarkTrace } from "../src/intelligence/trace/index.js";

const report = benchmarkTrace({ seed: "golden-trace" });
const failed = [];

if (report.passed !== report.total) {
  failed.push(`Passed ${report.passed}/${report.total}; expected all Trace benchmarks to pass.`);
}
